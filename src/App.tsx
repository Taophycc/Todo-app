...
function App() {
  ...
  return (
    <div className="min-h-screen bg-very-light-gray dark:bg-very-dark-blue font-josefin transition-colors duration-300 flex flex-col">
      ...
      <div className={`relative w-full h-[200px] md:h-[300px] bg-cover bg-center z-0 ${theme === 'dark' ? 'bg-header-dark' : 'bg-header-light'}`}>
        <div className="relative z-10 w-full max-w-xl lg:max-w-2xl mx-auto px-6 pt-12 md:pt-16">
      ...
      <main className="flex-1 flex justify-center items-start pt-0 px-4">
        <div className="relative z-20 w-full max-w-xl lg:max-w-2xl px-6 -mt-16 md:-mt-20 min-h-0">
